...
export const insights = [
  {
    ...
    content: [
      'For most of the last decade, institutional engagement with digital assets was a question of whether. That question has been settled. The conversation now is one of how much, in what form, and under what controls — a conversation institutions are well equipped to have, because it is the same one they apply to every other asset class.',
  ...
  },
  {
    ...
    content: [
      ...
      'For an institution, no return justifies an uncontrolled custody arrangement. The history of this asset class is, in large part, a history of custody failures — exchanges that commingled client funds, keys held by single individuals, and operational shortcuts that worked until they did not.',
  ...
  },
  {
    ...
    content: [
      ...
      'Broadly, on-chain yield falls into two categories. The first is fee-backed: returns paid from genuine economic activity — transaction fees, lending spreads, trading volume. This yield is, in principle, durable, because it reflects real demand. The second is incentive-backed: returns paid in newly issued tokens to attract capital. This yield can be substantial, but it is funded by dilution and tends to compress the moment incentives are withdrawn.',
  ...
  },
  {
    ...
    author: 'Eleanor Vance, CIO',
    content: [
      'The idea of holding bitcoin on a corporate or institutional balance sheet has moved from the fringe to the agenda of serious treasury committees. The case rests on a simple proposition: a scarce, liquid, globally portable asset with no counterparty may have a role alongside cash and short-duration instruments. The execution, however, is where the discipline lies.',
      { h: 'Liquidity first' },
  ...
  },
  {
    ...
    content: [
      ...
      'Multi-signature custody requires several independent keys to authorise a transaction, with a defined quorum — say, three of five. Multi-party computation goes further: a single key is never assembled in one place at all, but generated and used as distributed shares that jointly produce a signature. Both share one principle — that authority to move assets is split so that no individual, device, or location holds enough to act alone.',
  ...
  },
  {
    ...
    author: 'Priya Anand, Portfolio Manager',
    content: [
      'Tokenization — representing ownership of an asset as a digital token — has become one of the most discussed developments in the space, drawing in money-market funds, private credit and government securities. The opportunity is real. So is the temptation to confuse a new wrapper for a new asset.',
